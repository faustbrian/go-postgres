...
- security support and roadmap documentation reflect the stable v1 state
...
- Migration example checks no longer retain mutable checksums for local
  zero-version workspace modules.

# Goal Harden: `go-postgres`

## Mission

Perform an evidence-driven PostgreSQL, pgx, pooling, transaction, error,
observability, compatibility, and resource-safety audit of `go-postgres`, then
...
- `sqlc`, `go-migrations`, and OpenTelemetry contracts where examples or
  adapters use them
...
- executable `sqlc`, `go-migrations`, service, and worker examples

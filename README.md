...
`go-postgres` is focused production infrastructure for PostgreSQL applications
...
[`go-telemetry/instrumentation/gopostgres`](https://github.com/faustbrian/go-telemetry/tree/main/instrumentation/gopostgres)
